...
If you are using a different notebook editor than VS Code, start the editor using the virtual environment's Python instance to activate the kernel with all the packages.
